  ...
  return (
    <div>
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-64 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-zinc-800 p-4 transition-all duration-200 ease-in-out ${
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-xs uppercase text-amber-300 font-semibold pl-3">
              <span
                className="lg:block lg:sidebar-expanded:block 2xl:block">Dashboards</span>
            </h3>
            <ul className="mt-3">
              {/* Home */}
              <li
              ...
              <li
                ...
                >
                  <span
                    className="text-sm font-medium ml-3 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Environment</span>
                </NavLink>
              </li>
              {/* System Control */}
              <li
