  ...
  return (
    <div {...rest}>
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className={`origin-top-right z-10 absolute top-full min-w-36 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 py-1.5 rounded shadow-lg overflow-hidden mt-1 ${
